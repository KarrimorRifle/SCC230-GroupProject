...
| 11 | Manage Roles | As a **Hub admin** I want to manage roles of other accounts on the hub | The **hub admin** shall be able to change other **user**'s roles |  | &cross; |
| 12 | Remove schedule | As a **user** with appropriate role i want to be able to remove an inactive or unwanted schedule from the **hub** | The **app** shall allow **user** (perm oriented) to remove a schedule from the **hub** |  | &cross; |
| 13 | Modify Settings | As a **user** I want to modify my own settings | The **user** shall be able to modify account settings |  | &cross; |
| 14 | Toggle schedule activation | As a **user** with appropriate role I want to be able to activate/deactivate a schedule on the **hub** | The **app** shall allow **user** (perm oriented) to activate and deactivate schedules on **hub** |  | &cross; |
