...
| 16.0 | Request schedule activation | As a **user** having lower role want to be able to request owner for activation/deactivation of my schedule on the **hub** | Allow **user** with appropriate role to request hub owner activate and deactivate schedules on **hub** |  | &cross; |
