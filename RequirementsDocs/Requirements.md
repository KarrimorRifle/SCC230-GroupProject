...
| 12 | Remove schedule | As a **user** with appropriate role i want to be able to remove an inactive or unwanted schedule from the **hub** | The **app** allow **user** (perm oriented) to remove a schedule from the **hub** |  | &cross; |
